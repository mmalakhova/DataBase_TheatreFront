    ...
    return (
        <div className="content p-40">
            <div className="align-left justify-between">
                <h1 className="text-uppercase">постановщики</h1>
                <Form style={{ marginLeft: 40, marginRight: 40 }}>

                    <Row>

                        <label stylew={{ marginRight: 10, marginBottom: 10 }}>Сортировать по:</label>
                        <select style={{ width: 300, marginLeft: 10 }} className='form-select' name="colValue" onChange={handleChange}>
                            <option>Выберите</option>
                            <option value="name">Имя</option>
                            <option value="typeOfStageDirector">Тип постановщика</option>
            ...
            <div className="newsPanel d-flex flex-wrap">
                ...
                <Link to="/stagedirectors/add" style={{ marginLeft: 40, marginTop: 40, color: 'white' }} className="btn btn-dark mb-2">Добавить постановщика</Link>
                <Table style={{ marginTop: 20, marginRight: 40, marginLeft: 40 }} striped bordered hover variant="dark">
                    <thead >
                        <tr>
                            <th>Имя</th>
                            <th>Тип постановщика</th>
                            <th>Пол</th>
                            <th>Возраст</th>
                            <th>Действия</th>
                        </tr>
                    ...
                    <tbody>
                        {
                            stageDirectors.map(obj => (
                                <tr key={obj.id}>
                                    ...
                                    <td>{obj.age}</td>
                                    <td>
                                        <Link style={{ backgroundColor: "#D10000", borderColor: "#D10000" }} to={`/stagedirectors/edit/${obj.id}`} className='btn btn-danger'>Изменить</Link>
